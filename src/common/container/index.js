...
export default class Container extends React.Component {
  ...
  componentDidMount() {
    this.state.userInfo = JSON.parse(sessionStorage.getItem("user"))
    ...
    return (
      <Layout className="containAll">
        ...
        >
          ...
          { this.state.theme === 'light' ? <span className="author">{this.state.userInfo.username}</span> : <span className="author white">{this.state.userInfo.username}</span> }
          <Menu
        ...
        <Layout>
          <Top toggle={this.toggle} title = {this.state.userInfo.username} collapsed={this.state.collapsed} clear={this.clear} />
          <Contents />
          <Footer />
        </Layout>
      </Layout>
